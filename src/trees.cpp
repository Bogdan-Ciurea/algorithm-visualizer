...
bool Trees::draw() {
  ...
  DrawTextEx(inter_regular, "Trees Algorithms", (Vector2){75, button_height / 2 - 10}, 20, 0, DARKGRAY);

  // Draw all the algorithm options
  if (GuiDropdownBox((Rectangle){ (float)(80 + MeasureText("Trees Algorithms", 16)), button_height / 2 - 20, 135, 40},
      "BINARY;RED BLACK", 
