...
private:
  ...
  sort_search_input_options draw_buttons(int x, int y, char* text, float font_size, sort_search_input_options option);
  sort_search_input_options draw_buttons_with_image(int x, int y, int size, sort_search_input_options option, Texture2D texture);
